...
var CreatePost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_2 = _a.sent();
                if (error_2 && typeof error_2 === 'object' && 'isJoi' in error_2 && error_2.isJoi === true) {
                    return [2 /*return*/, next(res.status(400).json({
                            message: "Invalid details provided.",
                        }))];
                }
...
var getAllPost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                if (error_3 && typeof error_3 === 'object' && 'isJoi' in error_3 && error_3.isJoi === true) {
                    return [2 /*return*/, next(res.status(400).json({
                            message: "Invalid details provided.",
                        }))];
                }
...
var getPost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_4 = _a.sent();
                if (error_4 && typeof error_4 === 'object' && 'isJoi' in error_4 && error_4.isJoi === true) {
                    return [2 /*return*/, next(res.status(400).json({
                            message: "Invalid details provided.",
                        }))];
                }
...
var detelePost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_5 = _a.sent();
                if (error_5 && typeof error_5 === 'object' && 'isJoi' in error_5 && error_5.isJoi === true) {
                    return [2 /*return*/, next(res.status(400).json({
                            message: "Invalid details provided.",
                        }))];
                }
...
var updatePost = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_6 = _a.sent();
                if (error_6 && typeof error_6 === 'object' && 'isJoi' in error_6 && error_6.isJoi === true) {
                    return [2 /*return*/, next(res.status(400).json({
                            message: "Invalid details provided.",
                        }))];
                }
